...
<template>
    ...
    <div
        class="grid grid-cols-1 md:grid-cols-2 xl:grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 md:grid-cols-2 xl:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mt-8"
    >
